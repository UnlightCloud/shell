...
public class MatchWaitingView extends Thread {
    // 翻訳データ
    CONFIG::LOCALE_JP
    ...
    CONFIG::LOCALE_SCN
    private static const _TRANS_MSG:String = "与对手对战中";
...
//         private var _waitPanel:Panel = new Panel();
     ...
     * @param stage 親ステージ
     */
    public function MatchWaitingView(stage:Sprite, s:String) {
        _duel = Duel.instance;
        _match = Match.instance;
        _stage = stage;
        _uid = s;
        MatchCtrl.instance.waitingRun(this);
    }

    private function cancelHandler():void {
        MatchCtrl.instance.exitRoom(_uid);
    }
    ...
    private function show():void {
        next(connect);
//            WaitingPanel.show("Waiting...","対戦相手とマッチング中",!_player.joined,cancelHandler,this,[])
