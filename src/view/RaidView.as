...
public class RaidView extends Thread {
    ...
    private function chatCloseClickHandler(e:MouseEvent):void {
        ...
        pExec.addThread(new ClousureThread(function ():void {
            _raidDeck.changeNormalMode();
        }));
        pExec.addThread(new ClousureThread(function ():void {
            _raidChatArea.closeWindow();
        }));
        sExec.addThread(pExec);
        sExec.addThread(new SleepThread(200));
        sExec.addThread(new ClousureThread(function ():void {
            _bg.chatOpenBtnEventReset();
        }));
        sExec.start();
    }
