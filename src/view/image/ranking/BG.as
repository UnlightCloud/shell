...
public class BG extends BaseImage {
    // HP表示元SWF
    [Embed(source="../../../../res/data/image/ranking/entrance_rank.swf")]
...
//                btn_back,btn_next,top)
    ...
    override protected function swfinit(event:Event):void {
        ...
        _tabSet.forEach(function (item:*, index:int, array:Array):void {
            item.addEventListener(MouseEvent.CLICK, tabClickHandler)
        });
