...
public class CharaSelectImage extends BaseImage {
    ...
    // HP表示元SWF
    [Embed(source="../../../../res/data/image/regist/make_3chara.swf")]
    ...
    override protected function swfinit(event:Event):void {
        ...
        NAME_CHARAS.forEach(function (item:*, index:int, array:Array):void {
            _charas.push(MovieClip(_root.getChildByName(item)))
        });
