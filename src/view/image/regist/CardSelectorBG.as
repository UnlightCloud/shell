...
public class CardSelectorBG extends BaseImage {
    ...
    // HP表示元SWF
    [Embed(source="../../../../res/data/image/regist/make_3card.swf")]
    ...
    override protected function swfinit(event:Event):void {
        super.swfinit(event);
        NAME_CARDS.forEach(function (item:*, index:int, array:Array):void {
            _cards.push(SimpleButton(_root.getChildByName(item)))
        });
