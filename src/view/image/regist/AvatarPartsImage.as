...
public class AvatarPartsImage extends BaseImage {
    ...
    override protected function swfinit(event:Event):void {
        super.swfinit(event);
        NAME_ITEM_TYPE.forEach(function (item:*, index:int, array:Array):void {
            _itemType.push(SimpleButton(_root.getChildByName(item)))
        });
        NAME_ITEM_LIST.forEach(function (item:*, index:int, array:Array):void {
            _itemList.push(SimpleButton(_root.getChildByName(item)))
        });
