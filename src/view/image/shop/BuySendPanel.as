...
public class BuySendPanel extends Panel {
    ...
    private function setPos():void {
        if (_selecterSet) {
            ...
            // コイン
            _beforeCoins.forEach(function (item:*, index:int, array:Array):void {
                setCoinLabelPos(item, index, false)
            });
            _afterCoins.forEach(function (item:*, index:int, array:Array):void {
                setCoinLabelPos(item, index, true)
            });
