...
//            _container.addChild(_mapImage);
        ...
        _landMap.forEach(function (land:*, index:int, array:Vector.<QuestLandClip>):void {
            land.getShowThread(_container, 100).start()
        });
        _nextPass.forEach(function (land:*, index:int, array:Vector.<QuestPassClip>):void {
            land.getShowThread(_container, 0).start()
        });
