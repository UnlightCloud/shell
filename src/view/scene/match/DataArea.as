...
//                 "アバターのコメントです。",],
    ...
    private function initilizeToolTipOwners():void {
        ...
        _avatarName.forEach(function (item:*, index:int, array:Array):void {
            _toolTipOwnerArray.push([3, item])
        });  //
        _avatarPoint.forEach(function (item:*, index:int, array:Array):void {
            _toolTipOwnerArray.push([4, item])
        });  //
        _avatarResult.forEach(function (item:*, index:int, array:Array):void {
            _toolTipOwnerArray.push([5, item])
        });  //
        _avatarPercent.forEach(function (item:*, index:int, array:Array):void {
            _toolTipOwnerArray.push([6, item])
        });  //
    }
...
//                log.writeLog(log.LV_FATAL, this, "!!!!!!!!!!",room.avatarCcId[i]);
    ...
    private function hideAvatarClip():void {
        ...
        _avatarClip.forEach(function (item:*, index:int, array:Array):void {
            item.visible = true
        });
...
//            _avatarClip.forEach(function(item:*, index:int, array:Array):void{item.visible = false});
        ...
        _avatarLevel.forEach(function (item:*, index:int, array:Array):void {
            item.text = ""
        });
        _avatarName.forEach(function (item:*, index:int, array:Array):void {
            item.text = ""
        });
        _avatarPointTitle.forEach(function (item:*, index:int, array:Array):void {
            item.text = ""
        });
        _avatarPoint.forEach(function (item:*, index:int, array:Array):void {
            item.text = ""
        });
        _avatarResultTitle.forEach(function (item:*, index:int, array:Array):void {
            item.text = ""
        });
        _avatarResult.forEach(function (item:*, index:int, array:Array):void {
            item.text = ""
        });
        _avatarPercentTitle.forEach(function (item:*, index:int, array:Array):void {
            item.text = ""
        });
        _avatarPercent.forEach(function (item:*, index:int, array:Array):void {
            item.text = ""
