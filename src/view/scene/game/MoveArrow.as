...
//             GameCtrl.instance.addViewSequence(new BTThread(BetweenAS3.parallel(BetweenAS3.parallelTweens(plTweenArray),BetweenAS3.parallelTweens(foeTweenArray))));
        if (plTweenArray.length > 0) {
            GameCtrl.instance.addNoWaitViewSequence(new BTThread(BetweenAS3.parallelTweens(plTweenArray)));
        }
        ;
        if (foeTweenArray.length > 0) {
            GameCtrl.instance.addNoWaitViewSequence(new BTThread(BetweenAS3.parallelTweens(foeTweenArray)))
        }
        if (hideTweenArray.length > 0) {
        ...
        if (hideTweenArray.length > 0) {
            GameCtrl.instance.addViewSequence(new BTThread(BetweenAS3.parallelTweens(hideTweenArray)))
        }
        ;
