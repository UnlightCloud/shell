        ...
        BetweenAS3.tween(_metaContainer,
                {
                    transform: {
                        colorTransform: {
                            redMultiplier: DEAD_COLOR,
                            greenMultiplier: DEAD_COLOR,
                            blueMultiplier: DEAD_COLOR
                        }
                    }
                },
                null,
        ...
        BetweenAS3.tween(_metaContainer,
                {
                    transform: {
                        colorTransform: {
                            redMultiplier: ALIVE_COLOR,
                            greenMultiplier: ALIVE_COLOR,
                            blueMultiplier: ALIVE_COLOR
                        }
                    }
                },
                null,
