...
public class Channel extends BaseModel {
    ...
    public static function initChannelList(id:Array, name:Array, rule:Array, capacity:Array, host:Array, port:Array, duelHost:Array, duelPort:Array, chatHost:Array, chatPort:Array, watchHost:Array, watchPort:Array, state:Array, caption:Array, count:Array, penaltyType:Array, costLimitMin:Array, costLimitMax:Array, watchMode:Array):void {
        Channel.list = [];
        id.forEach(function (item:*, idx:int, array:Array):void {
            new Channel(id[idx], name[idx], rule[idx], capacity[idx], host[idx], port[idx], duelHost[idx], duelPort[idx], chatHost[idx], chatPort[idx], watchHost[idx], watchPort[idx], state[idx], caption[idx], count[idx], penaltyType[idx], costLimitMin[idx], costLimitMax[idx], watchMode[idx])
        });
        __loaded = true;
        current = -1;
    }
