...
public class Shop extends BaseModel {
    ...
    private var _basisItemList:Array;    /* of AvatarItem*/
    ;   // 名前
    private var _autoPlayItemList:Array;    /* of AvatarItem*/
    ;   // 名前
    private var _duelItemList:Array;    /* of AvatarItem*/
    ;   // 名前
    private var _spcialItemList:Array;    /* of AvatarItem*/
    ;   // 名前
    private var _salePartsList:Array;    /* of AvatarBodyParts */
    ;   // 名前
