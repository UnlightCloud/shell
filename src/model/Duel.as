...
public class Duel extends BaseModel {
    ...
    public function initialize(plCCID:Array, foeCCID:Array, stage:int = 0, plDameges:Array = null, foeDamages:Array = null, raidBoss:Boolean = false):void {
        ...
        plCCID.forEach(function (item:*, index:int, array:Array):void {
            _playerCharaCards.push(CharaCard.ID(item))
        });
        foeCCID.forEach(function (item:*, index:int, array:Array):void {
            _foeCharaCards.push(CharaCard.ID(item))
        });
