...
public class SoundCtrl extends EventDispatcher {
    ...
    public function set BGMVolume(v:int):void {
        ...
        __currentBGMChannels.forEach(function (item:*, index:int, vector:Vector.<SoundChannel>):void {
...
//            log.writeLog(log.LV_FATAL, this, "volume change", __bgmVolume);
    ...
    public function set SEVolume(v:int):void {
        ...
        __currentSEChannels.forEach(function (item:*, index:int, vector:Vector.<SoundChannel>):void {
            item.soundTransform = trans
        });
    ...
    public function set CVVolume(v:int):void {
        ...
        __currentCVChannels.forEach(function (item:*, index:int, vector:Vector.<SoundChannel>):void {
            item.soundTransform = trans
        });
